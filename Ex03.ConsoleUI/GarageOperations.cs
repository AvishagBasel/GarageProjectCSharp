...
namespace Ex03.ConsoleUI
{
    internal class GarageOperations
    {
        internal static void ShowGarageOptions(Garage i_Garage)
        {
            ...
            // $G$ CSS-999 (0) I'ts a bad practice to use while (true), instead need to assign the true value to variable
            // and test the variable itself in the while statement.
            while (true)
            {
                Console.WriteLine(
